...
namespace ConsoleApplication1
{
    ...
    public class ProjectOpeningSteps
    {
        ...
        public static void BeforeTestRun()
        {
            ...
            window = application.GetWindow(SearchCriteria.ByAutomationId("WizardForm"), InitializeOption.NoCache);
            //window.WaitWhileBusy();
            ...
            nextButton.Click();
            window.Get(SearchCriteria.ByAutomationId("_loadSamplesCheckBox")).Click();
